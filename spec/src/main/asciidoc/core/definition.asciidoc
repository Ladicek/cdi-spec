...
Certain built-in beans defined by this specification have an infinite set of bean types.
User-defined beans always have a finite set of bean types.
...
Certain built-in beans defined by this specification have an infinite set of qualifiers.
User-defined beans always have a finite set of qualifiers.
